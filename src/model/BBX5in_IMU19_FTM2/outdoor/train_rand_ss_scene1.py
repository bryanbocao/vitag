...
$ python3 train.py -l b

Train with MSE loss
$ python3 train.py -l mse

Resume training
$ python3 train.py -l b -rt True

Random subsampling
$ python3 train_rand_ss_scene1.py -l mse -tsid_idx 4
$ python3 train_rand_ss_scene1.py -l mse -tsid_idx 4 -rt
$ python3 train_rand_ss_scene1.py -l mse -trid_sc_idx_ls 1 -tsid_idx 4
$ python3 train_rand_ss_scene1.py -l mse -trid_sc_idx_ls 1 -tsid_idx 4 -rt
'''
...
class Config:
    def __init__(self):
        ...
        self.parser.add_argument('-tt', '--test_type', type=str, default='rand_ss')
        # self.parser.add_argument('-trs_idx', '--train_seq_id_idx', type=int)
        ...
        self.model_id = 'X22_Outdoor_BBX5in_IMU19_FTM2_' # edit
        if self.args.loss == 'b': self.model_id = self.model_id[:self.model_id.index('FTM2_') + len('FTM_2')] + 'Bloss_scene'
        if self.test_type == 'rand_ss': self.model_id += 'rand_ss_scene1_seq_' + str(self.args.test_seq_id_idx)
        elif self.test_type == 'crowded': self.model_id += 'crowded'
        # for train_scene_id_idx in self.train_scene_id_idx_ls:
        #     self.model_id += str(train_scene_id_idx)
        ...
        for train_scene_id_idx in self.train_scene_id_idx_ls:
            ...
            with open(self.train_seq_id_ls_path, 'r') as f:
                ...
                for i, row in enumerate(csv_reader):
                    if self.test_type == 'crowded': self.train_seq_id_ls.append(row[0])
                    elif i != self.test_seq_id_idx and 'scene' not in row[0] and row[0] != '20211004_144536':
                        # crowded '20211004_144536' in scene1 is hold out
                        self.train_seq_id_ls.append(row[0]) # e.g. 20211006_141820

        if self.test_type == 'normal':
            self.test_seq_id_ls_path = self.exp_path_for_model + '/' + self.test_type + '_test_seq_id_ls.csv'
        elif self.test_type == 'rand_ss' or self.test_type == 'crowded':
            self.test_seq_id_ls_path = self.exp_path_for_model + '/rand_ss_seq_id_ls_scene'  + str(self.train_scene_id_idx_ls[0]) + '.csv' # edit
        print(); print() # debug
        ...
        e.g. ['20210907_145202', '20211004_142306', '20211006_152208', '20211007_105924',
            '20211007_134632']
        '''
        self.seq_id = '20211004_142306' # dummy one, to be updated in prepare_training_data()
...
def prepare_training_data():
    ...
    # ---------------------------------------
    for C.seq_id in C.train_seq_id_ls:
        print()
        ...
        C.video_len = len(C.RGB_ts16_dfv3_valid_ls) # len(C.ts12_BBX5_all)
        print(); print() # debug
    ...
    print(); print() # debug
    print(C.train_seq_id_ls)
    print()
    print('C.test_seq_id_idx: ', C.test_seq_id_idx)
    print()
