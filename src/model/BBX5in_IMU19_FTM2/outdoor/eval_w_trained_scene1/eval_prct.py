...
'''
Command examples:
$ python3 eval_prct.py -fps 10 -tt rand_ss -k 10 -tsid_idx 0
$ python3 eval_prct.py -fps 10 -tt rand_ss -k 10 -tsid_idx 1
$ python3 eval_prct.py -fps 10 -tt rand_ss -k 10 -tsid_idx 2
$ python3 eval_prct.py -fps 10 -tt crowded -k 10 -tsid_idx 0
$ python3 eval_prct.py -fps 10 -tt crowded -k 10 -tsid_idx 1
$ python3 eval_prct.py -fps 10 -tt crowded -k 10 -tsid_idx 2
$ python3 eval_prct.py -fps 10 -tt rand_ss -k 10 -tsid_idx 0 -nl 0.1
$ python3 eval_prct.py -fps 10 -tt rand_ss -k 10 -tsid_idx 0 -nl 0.3
$ python3 eval_prct.py -fps 10 -tt rand_ss -k 10 -tsid_idx 0 -nl 0.5
'''
...
class Config:
    def __init__(self):
        ...
        # if self.args.loss == 'mse': self.model_id = 'X22_BBX5in_IMU19_FTM2_rand_ss_scene1' # 'X22_BBX5in_IMU19_FTM2_scene1' # edit
        # elif self.args.loss == 'b': self.model_id = 'X22_BBX5in_IMU19_FTM2_Bloss_scene1' # edit
        self.model_id = 'X22_outdoor_rand_ss_scene1_prct'
        self.model_id += '_'
        ...
        self.IMU_NED_pos_sync_dfv3 = [] # prct
        ...
        self.IMU_NED_pos_sync_dfv3_path = self.sync_dfv3_path + '/IMU_NED_pos_sync_dfv3.pkl' # prct
...
def prepare_testing_data():
    ...
    seq_in_IMU19_dfv3_ls, seq_in_IMU_NED_pos_dfv3_ls = [], [] # prct
            ...
            if len(seq_in_IMU_NED_pos_) == C.recent_K: # prct
                ...
                if C.args.noise_level > 0.0:
                    ...
                    for k in range(C.recent_K):
                        # noise19_in_k = [np.random.normal(0, C.IMU19_subj_i_std_ls[subj_i][d]) * C.args.noise_level for d in range(C.IMU19_dim)]
            ...
            if n > 0:
                ...
                for r_i, subj_i_r in enumerate(seq_subj_i_in_view_ls_):
                    ...
                    for c_i in range(len(C.subjects) - 1):
                        ...
                        # >>> prct >>>
                        seq_in_FTM2_c_avg = np.expand_dims(seq_in_FTM2_c[:,:,0], axis=2)
                        ...
                        # print('seq_in_BBXC3_r: ', seq_in_BBXC3_r)
                        # print('seq_in_Phone3_c: ', seq_in_Phone3_c)
                        # print('np.shape(seq_in_BBXC3_r): ', np.shape(seq_in_BBXC3_r)) # e.g. (1, 10, 3)
                        # print('np.shape(seq_in_Phone3_c): ', np.shape(seq_in_Phone3_c)) # e.g. (1, 10, 3)
                        '''
                        e.g.
